...
public class FigureNameFive extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.figure_five);
        ...
        correct = MediaPlayer.create(FigureNameFive.this, R.raw.correcto);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!btOne.isFocusable()) {
                    ...
                    startActivity(new Intent(FigureNameFive.this, classF[rF.nextInt(classF.length)]));
                    finish();
        ...
        btOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer figure = MediaPlayer.create(FigureNameFive.this, R.raw.rombo);
                figure.start();
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(FigureNameFive.this, R.raw.ayuda_figuras);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_four) {
                        ...
                        MediaPlayer media = MediaPlayer.create(FigureNameFive.this, R.raw.resorte);
                        media.start();
