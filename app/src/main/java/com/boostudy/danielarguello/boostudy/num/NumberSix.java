...
public class NumberSix extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(NumberSix.this, R.raw.correcto);

        nueve = MediaPlayer.create(NumberSix.this, R.raw.nueve);
        diez = MediaPlayer.create(NumberSix.this, R.raw.diez);
        tres = MediaPlayer.create(NumberSix.this, R.raw.tres);
        seis = MediaPlayer.create(NumberSix.this, R.raw.seis);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btThree.isFocusable()) {
                    ...
                    startActivity(new Intent(NumberSix.this, classeN[rN.nextInt(classeN.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_three && v.getId() == R.id.target_three) {
                        ...
                        MediaPlayer media = MediaPlayer.create(NumberSix.this, R.raw.resorte);
                        media.start();
    ...
    public void iniciarNumberSix(View v){
        Intent i = new Intent(this, NumberSix.class);
        startActivity(i);
    }
}
