...
public class MayusSeven extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mayus_seven);
        ...
        correct = MediaPlayer.create(MayusSeven.this, R.raw.correcto);

        w = MediaPlayer.create(MayusSeven.this, R.raw.w);
        x = MediaPlayer.create(MayusSeven.this, R.raw.x);
        y = MediaPlayer.create(MayusSeven.this, R.raw.y);
        z = MediaPlayer.create(MayusSeven.this, R.raw.z);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(MayusSeven.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(MayusSeven.this, R.raw.ayuda_mayus);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(MayusSeven.this, R.raw.resorte);
                        media.start();
