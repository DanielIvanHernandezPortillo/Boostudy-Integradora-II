...
public class MayusTwo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mayus_two);
        ...
        correct = MediaPlayer.create(MayusTwo.this, R.raw.correcto);

        e = MediaPlayer.create(MayusTwo.this, R.raw.e);
        f = MediaPlayer.create(MayusTwo.this, R.raw.f);
        g = MediaPlayer.create(MayusTwo.this, R.raw.g);
        h = MediaPlayer.create(MayusTwo.this, R.raw.h);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(MayusTwo.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(MayusTwo.this, R.raw.ayuda_mayus);
                info.start();
            }
        });
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_four) {
                    ...
                    } else if (view.getId() == R.id.bt_three && v.getId() == R.id.target_three) {
                        LinearLayout oldparent = (LinearLayout) view.getParent();
                        oldparent.removeView(view);
                        LinearLayout newParent = (LinearLayout) v;
                    ...
                    } else if (view.getId() == R.id.bt_four && v.getId() == R.id.target_on) {
                        LinearLayout oldparent = (LinearLayout) view.getParent();
                        oldparent.removeView(view);
                        LinearLayout newParent = (LinearLayout) v;
                        ...
                        MediaPlayer media = MediaPlayer.create(MayusTwo.this, R.raw.resorte);
                        media.start();
