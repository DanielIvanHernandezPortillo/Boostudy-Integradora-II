...
/**
 * Created by DANIEL ARGUELLO on 18/04/2017.
 */

public class AgroupZero extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agrup_zero);
        ...
        correct = MediaPlayer.create(AgroupZero.this, R.raw.correcto);

        uno = MediaPlayer.create(AgroupZero.this, R.raw.uno);
        siete = MediaPlayer.create(AgroupZero.this, R.raw.siete);
        cinco = MediaPlayer.create(AgroupZero.this, R.raw.cinco);
        dos = MediaPlayer.create(AgroupZero.this, R.raw.dos);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(AgroupZero.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_four) {
                        ...
                        MediaPlayer media = MediaPlayer.create(AgroupZero.this, R.raw.resorte);
                        media.start();
