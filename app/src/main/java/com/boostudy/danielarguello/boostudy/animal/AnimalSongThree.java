...
public class AnimalSongThree extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.animal_song_three);
        ...
        correct = MediaPlayer.create(AnimalSongThree.this, R.raw.correcto);

        gallo = MediaPlayer.create(AnimalSongThree.this, R.raw.gallo);
        vaca = MediaPlayer.create(AnimalSongThree.this, R.raw.vaca);
        abeja = MediaPlayer.create(AnimalSongThree.this, R.raw.abeja);
        cerdo = MediaPlayer.create(AnimalSongThree.this, R.raw.cerdito);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(AnimalSongThree.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                    ...
                    } else if (view.getId() == R.id.bt_three && v.getId() == R.id.target_four) {
                        LinearLayout oldparent = (LinearLayout) view.getParent();
                        oldparent.removeView(view);
                        LinearLayout newParent = (LinearLayout) v;
                    ...
                    } else if (view.getId() == R.id.bt_four && v.getId() == R.id.target_one) {
                        LinearLayout oldparent = (LinearLayout) view.getParent();
                        oldparent.removeView(view);
                        LinearLayout newParent = (LinearLayout) v;
                        ...
                        MediaPlayer media = MediaPlayer.create(AnimalSongThree.this, R.raw.resorte);
                        media.start();
