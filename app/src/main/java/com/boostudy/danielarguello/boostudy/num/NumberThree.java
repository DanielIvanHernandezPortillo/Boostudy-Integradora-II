...
public class NumberThree extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(NumberThree.this, R.raw.correcto);

        ocho = MediaPlayer.create(NumberThree.this, R.raw.ocho);
        diez = MediaPlayer.create(NumberThree.this, R.raw.diez);
        tres = MediaPlayer.create(NumberThree.this, R.raw.tres);
        uno = MediaPlayer.create(NumberThree.this, R.raw.uno);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btThree.isFocusable()) {
                    ...
                    startActivity(new Intent(NumberThree.this, classeN[rN.nextInt(classeN.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_three && v.getId() == R.id.target_four) {
                        ...
                        MediaPlayer media = MediaPlayer.create(NumberThree.this, R.raw.resorte);
                        media.start();
    ...
    public void iniciarNumberThree(View v){
        Intent i = new Intent(this, NumberThree.class);
        startActivity(i);
    }
}
