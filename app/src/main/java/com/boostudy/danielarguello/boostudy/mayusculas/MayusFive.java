...
public class MayusFive extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mayus_five);
        ...
        correct = MediaPlayer.create(MayusFive.this, R.raw.correcto);

        r = MediaPlayer.create(MayusFive.this, R.raw.r);
        s = MediaPlayer.create(MayusFive.this, R.raw.s);
        t = MediaPlayer.create(MayusFive.this, R.raw.t);
        q = MediaPlayer.create(MayusFive.this, R.raw.q);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(MayusFive.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(MayusFive.this, R.raw.ayuda_mayus);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_three) {
                        ...
                        MediaPlayer media = MediaPlayer.create(MayusFive.this, R.raw.resorte);
                        media.start();
