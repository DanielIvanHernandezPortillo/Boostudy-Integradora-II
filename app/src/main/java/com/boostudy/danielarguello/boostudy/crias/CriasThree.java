...
public class CriasThree extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.crias_three);
        ...
        correct = MediaPlayer.create(CriasThree.this, R.raw.correcto);

        cordero = MediaPlayer.create(CriasThree.this, R.raw.cordero);
        osezno = MediaPlayer.create(CriasThree.this, R.raw.osezno);
        pichon = MediaPlayer.create(CriasThree.this, R.raw.pichon);
        alevin = MediaPlayer.create(CriasThree.this, R.raw.alevin);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(CriasThree.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(CriasThree.this, R.raw.ayuda_crias);
                info.start();
            }
        });
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_four) {
                    ...
                    } else if (view.getId() == R.id.bt_two && v.getId() == R.id.target_two) {
                        LinearLayout oldparent = (LinearLayout) view.getParent();
                        oldparent.removeView(view);
                        LinearLayout newParent = (LinearLayout) v;
                    ...
                    } else if (view.getId() == R.id.bt_four && v.getId() == R.id.target_three) {
                        LinearLayout oldparent = (LinearLayout) view.getParent();
                        oldparent.removeView(view);
                        LinearLayout newParent = (LinearLayout) v;
                        ...
                        MediaPlayer media = MediaPlayer.create(CriasThree.this, R.raw.resorte);
                        media.start();
