...
public class NumberTen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(NumberTen.this, R.raw.correcto);

        cuatro = MediaPlayer.create(NumberTen.this, R.raw.cuarenta);
        seis = MediaPlayer.create(NumberTen.this, R.raw.seis);
        siete = MediaPlayer.create(NumberTen.this, R.raw.siete);
        diez = MediaPlayer.create(NumberTen.this, R.raw.diez);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btThree.isFocusable()) {
                    ...
                    startActivity(new Intent(NumberTen.this, classeN[rN.nextInt(classeN.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_three && v.getId() == R.id.target_four) {
                        ...
                        MediaPlayer media = MediaPlayer.create(NumberTen.this, R.raw.resorte);
                        media.start();
    ...
    public void iniciarNumberTen(View v){
        Intent i = new Intent(this, NumberTen.class);
        startActivity(i);
    }
