...
public class FigureNameSeven extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.figure_seven);
        ...
        correct = MediaPlayer.create(FigureNameSeven.this, R.raw.correcto);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!btOne.isFocusable()) {
                    ...
                    startActivity(new Intent(FigureNameSeven.this, classF[rF.nextInt(classF.length)]));
                    finish();
        ...
        btOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer figure = MediaPlayer.create(FigureNameSeven.this, R.raw.pentagono);
                figure.start();
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(FigureNameSeven.this, R.raw.ayuda_figuras);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(FigureNameSeven.this, R.raw.resorte);
                        media.start();
