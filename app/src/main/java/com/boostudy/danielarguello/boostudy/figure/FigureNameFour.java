...
public class FigureNameFour extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.figure_four);
        ...
        correct = MediaPlayer.create(FigureNameFour.this, R.raw.correcto);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!btOne.isFocusable()) {
                    ...
                    startActivity(new Intent(FigureNameFour.this, classF[rF.nextInt(classF.length)]));
                    finish();
        ...
        btOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer figure = MediaPlayer.create(FigureNameFour.this, R.raw.rectangulo);
                figure.start();
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(FigureNameFour.this, R.raw.ayuda_figuras);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(FigureNameFour.this, R.raw.resorte);
                        media.start();
