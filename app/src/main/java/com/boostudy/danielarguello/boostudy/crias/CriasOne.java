...
public class CriasOne extends Activity {
    ...
    MediaPlayer correct;
    MediaPlayer aguilucho;
    MediaPlayer pollino;
    MediaPlayer potro;
    MediaPlayer ballenato;
    MediaPlayer ayuda;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.crias_one);
        ...
        correct = MediaPlayer.create(CriasOne.this, R.raw.correcto);

        aguilucho = MediaPlayer.create(CriasOne.this, R.raw.aguilucho);
        ballenato = MediaPlayer.create(CriasOne.this, R.raw.ballenato);
        pollino = MediaPlayer.create(CriasOne.this, R.raw.pollino);
        potro = MediaPlayer.create(CriasOne.this, R.raw.potro);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(CriasOne.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(CriasOne.this, R.raw.ayuda_crias);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_three) {
                        ...
                        MediaPlayer media = MediaPlayer.create(CriasOne.this, R.raw.resorte);
                        media.start();
