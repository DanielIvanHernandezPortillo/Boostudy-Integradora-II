...
public class MayusSix extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mayus_six);
        ...
        correct = MediaPlayer.create(MayusSix.this, R.raw.correcto);

        w = MediaPlayer.create(MayusSix.this, R.raw.w);
        v = MediaPlayer.create(MayusSix.this, R.raw.v);
        u = MediaPlayer.create(MayusSix.this, R.raw.u);
        x = MediaPlayer.create(MayusSix.this, R.raw.x);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(MayusSix.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(MayusSix.this, R.raw.ayuda_mayus);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(MayusSix.this, R.raw.resorte);
                        media.start();
