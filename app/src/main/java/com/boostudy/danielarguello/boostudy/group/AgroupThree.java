...
public class AgroupThree extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agrup_three);
        ...
        correct = MediaPlayer.create(AgroupThree.this, R.raw.correcto);

        diez = MediaPlayer.create(AgroupThree.this, R.raw.diez);
        cuatro = MediaPlayer.create(AgroupThree.this, R.raw.cuatro);
        siete = MediaPlayer.create(AgroupThree.this, R.raw.siete);
        uno = MediaPlayer.create(AgroupThree.this, R.raw.uno);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(AgroupThree.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(AgroupThree.this, R.raw.resorte);
                        media.start();
