...
/**
 * Created by karla on 22/03/2017.
 */

public class NumberTwo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(NumberTwo.this, R.raw.correcto);

        nueve = MediaPlayer.create(NumberTwo.this, R.raw.nueve);
        dos = MediaPlayer.create(NumberTwo.this, R.raw.dos);
        cero = MediaPlayer.create(NumberTwo.this, R.raw.cero);
        cinco = MediaPlayer.create(NumberTwo.this, R.raw.cinco);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btThree.isFocusable()) {
                    ...
                    startActivity(new Intent(NumberTwo.this, classeN[rN.nextInt(classeN.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_three && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(NumberTwo.this, R.raw.resorte);
                        media.start();
    ...
    public void iniciarNumberTwo(View v){
        Intent i = new Intent(this, NumberTwo.class);
        startActivity(i);
    }
