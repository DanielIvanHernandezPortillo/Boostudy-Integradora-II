...
public class MayusFour extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mayus_four);
        ...
        correct = MediaPlayer.create(MayusFour.this, R.raw.correcto);

        n = MediaPlayer.create(MayusFour.this, R.raw.n);
        m = MediaPlayer.create(MayusFour.this, R.raw.m);
        o = MediaPlayer.create(MayusFour.this, R.raw.o);
        p = MediaPlayer.create(MayusFour.this, R.raw.p);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(MayusFour.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(MayusFour.this, R.raw.ayuda_mayus);
                info.start();
            }
        });
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_on) {
                        ...
                        MediaPlayer media = MediaPlayer.create(MayusFour.this, R.raw.resorte);
                        media.start();
