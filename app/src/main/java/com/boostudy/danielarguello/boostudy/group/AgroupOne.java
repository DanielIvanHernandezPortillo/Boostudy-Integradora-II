...
/**
 * Created by DANIEL ARGUELLO on 20/04/2017.
 */

public class AgroupOne  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agrup_one);
        ...
        correct = MediaPlayer.create(AgroupOne.this, R.raw.correcto);

        tres = MediaPlayer.create(AgroupOne.this, R.raw.tres);
        ocho = MediaPlayer.create(AgroupOne.this, R.raw.ocho);
        cinco = MediaPlayer.create(AgroupOne.this, R.raw.cinco);
        nueve = MediaPlayer.create(AgroupOne.this, R.raw.nueve);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(AgroupOne.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_three) {
                        ...
                        MediaPlayer media = MediaPlayer.create(AgroupOne.this, R.raw.resorte);
                        media.start();
