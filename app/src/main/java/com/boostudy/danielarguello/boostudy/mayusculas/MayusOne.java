...
public class MayusOne extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mayus_one);
        ...
        correct = MediaPlayer.create(MayusOne.this, R.raw.correcto);

        a = MediaPlayer.create(MayusOne.this, R.raw.a);
        b = MediaPlayer.create(MayusOne.this, R.raw.b);
        c = MediaPlayer.create(MayusOne.this, R.raw.c);
        d = MediaPlayer.create(MayusOne.this, R.raw.d);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(MayusOne.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(MayusOne.this, R.raw.ayuda_mayus);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(MayusOne.this, R.raw.resorte);
                        media.start();
