...
public class AnimalSongFour extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.animal_song_four);
        ...
        correct = MediaPlayer.create(AnimalSongFour.this, R.raw.correcto);

        pato = MediaPlayer.create(AnimalSongFour.this, R.raw.pato);
        pajaro = MediaPlayer.create(AnimalSongFour.this, R.raw.pajaro);
        oveja = MediaPlayer.create(AnimalSongFour.this, R.raw.oveja);
        delfin = MediaPlayer.create(AnimalSongFour.this, R.raw.delfin);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(AnimalSongFour.this, classes[r.nextInt(classes.length)]));
                    finish();
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_two) {
                        ...
                        MediaPlayer media = MediaPlayer.create(AnimalSongFour.this, R.raw.resorte);
                        media.start();
