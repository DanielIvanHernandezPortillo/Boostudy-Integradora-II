...
public class NumberFour extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(NumberFour.this, R.raw.correcto);

        ocho = MediaPlayer.create(NumberFour.this, R.raw.ocho);
        siete = MediaPlayer.create(NumberFour.this, R.raw.siete);
        cuatro = MediaPlayer.create(NumberFour.this, R.raw.cuatro);
        cero = MediaPlayer.create(NumberFour.this, R.raw.cero);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btThree.isFocusable()) {
                    ...
                    startActivity(new Intent(NumberFour.this, classeN[rN.nextInt(classeN.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_three && v.getId() == R.id.target_one) {
                        ...
                        MediaPlayer media = MediaPlayer.create(NumberFour.this, R.raw.resorte);
                        media.start();
    ...
    public void iniciarNumberFour(View v){
        Intent i = new Intent(this, NumberFour.class);
        startActivity(i);
    }
}
