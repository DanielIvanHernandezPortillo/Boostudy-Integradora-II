...
public class NumberSeven extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(NumberSeven.this, R.raw.correcto);

        siete = MediaPlayer.create(NumberSeven.this, R.raw.siete);
        dos = MediaPlayer.create(NumberSeven.this, R.raw.dos);
        cuatro = MediaPlayer.create(NumberSeven.this, R.raw.cuarenta);
        cinco = MediaPlayer.create(NumberSeven.this, R.raw.cinco);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btThree.isFocusable()) {
                    ...
                    startActivity(new Intent(NumberSeven.this, classeN[rN.nextInt(classeN.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_three && v.getId() == R.id.target_one) {
                        ...
                        MediaPlayer media = MediaPlayer.create(NumberSeven.this, R.raw.resorte);
                        media.start();
    ...
    public void iniciarNumberSeven(View v){
        Intent i = new Intent(this, NumberSeven.class);
        startActivity(i);
    }
