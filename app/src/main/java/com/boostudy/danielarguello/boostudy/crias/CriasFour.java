...
public class CriasFour extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.crias_four);
        ...
        correct = MediaPlayer.create(CriasFour.this, R.raw.correcto);

        lobezno = MediaPlayer.create(CriasFour.this, R.raw.lobezno);
        potro = MediaPlayer.create(CriasFour.this, R.raw.potro);
        cachorro = MediaPlayer.create(CriasFour.this, R.raw.cachorro);
        ternero = MediaPlayer.create(CriasFour.this, R.raw.ternero);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btOne.isFocusable() && !btTwo.isFocusable() && !btThree.isFocusable() && !btFour.isFocusable()) {
                    ...
                    startActivity(new Intent(CriasFour.this, classes[r.nextInt(classes.length)]));
                    finish();
                }
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(CriasFour.this, R.raw.ayuda_crias);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_three) {
                        ...
                        MediaPlayer media = MediaPlayer.create(CriasFour.this, R.raw.resorte);
                        media.start();
