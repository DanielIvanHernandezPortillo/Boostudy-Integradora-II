...
public class NumberNine extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct = MediaPlayer.create(NumberNine.this, R.raw.correcto);

        nueve = MediaPlayer.create(NumberNine.this, R.raw.nueve);
        cuatro = MediaPlayer.create(NumberNine.this, R.raw.cuarenta);
        uno = MediaPlayer.create(NumberNine.this, R.raw.uno);
        seis = MediaPlayer.create(NumberNine.this, R.raw.seis);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!btThree.isFocusable()) {
                    ...
                    startActivity(new Intent(NumberNine.this, classeN[rN.nextInt(classeN.length)]));
                    finish();
                }
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_three && v.getId() == R.id.target_three) {
                        ...
                        MediaPlayer media = MediaPlayer.create(NumberNine.this, R.raw.resorte);
                        media.start();
    ...
    public void iniciarNumberNine(View v){
