...
public class FigureNameEight extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.figure_eight);
        ...
        correct = MediaPlayer.create(FigureNameEight.this, R.raw.correcto);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!btOne.isFocusable()) {
                    ...
                    startActivity(new Intent(FigureNameEight.this, classF[rF.nextInt(classF.length)]));
                    finish();
        ...
        btOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer figure = MediaPlayer.create(FigureNameEight.this, R.raw.exagono);
                figure.start();
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(FigureNameEight.this, R.raw.ayuda_figuras);
                info.start();
            }
        });
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.bt_one && v.getId() == R.id.target_one) {
                        ...
                        MediaPlayer media = MediaPlayer.create(FigureNameEight.this, R.raw.resorte);
                        media.start();
