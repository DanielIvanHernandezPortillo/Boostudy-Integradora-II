...
public class FigureNameOne extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.figure_one);
        ...
        correct = MediaPlayer.create(FigureNameOne.this, R.raw.correcto);
        ...
        btSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!btOne.isFocusable()) {
                    ...
                    startActivity(new Intent(FigureNameOne.this, classF[rF.nextInt(classF.length)]));
                    finish();
        ...
        btOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer figure = MediaPlayer.create(FigureNameOne.this, R.raw.triangulo);
                figure.start();
            }
        });
        ...
        btInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MediaPlayer info = MediaPlayer.create(FigureNameOne.this, R.raw.ayuda_figuras);
                info.start();
            }
        });
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    correct.start();
                        ...
                        MediaPlayer media = MediaPlayer.create(FigureNameOne.this, R.raw.resorte);
                        media.start();
